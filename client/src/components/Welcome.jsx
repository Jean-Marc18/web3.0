      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          ...
          <p className="text-left mt-5 text-white font-light mf:w-9/12 w-11/12 text-base">
            Explore the crypto world. Buy and sell cryptocurrencies easily on k-krypto.
          </p>
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0">
          <div className="p-3 mf:mt-0 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism ">
